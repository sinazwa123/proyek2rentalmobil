            ...
            <form action="{{ route('pemesan-store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" class="form-control @error('nama_pemesan') is-invalid @enderror" id="nama_pemesan" name="nama_pemesan" value="{{ old('nama_pemesan') }}"  placeholder="Enter Nama Mobil">
                    ...
                    <div class="form-group mb-3">
                        <label for="avatar">Foto Pemesan</label>
                        <div class="input-group">
                            <input type="file" class="form-control" id="foto_pemesan" name="foto_pemesan">
                        </div>
