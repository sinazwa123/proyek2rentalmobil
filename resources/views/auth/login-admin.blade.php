  ...
  background:aqua;
    ...
    <!-- <body data-layout="horizontal"> -->
        ...
        <div class="d-lg-flex half">
            <div class="bg order-1 bg-perpus order-md-2" style="background-image: url('assets/img/Rental/rental-4.png'); "></div>
            <div class="contents">
                  ...
                  <div class="col-md-6">
                    <div class="mb-4 mb-md-5 text-center">
                        <a href="index.html" class="d-block auth-logo">
                            <img src="assets/img/Rental/rental-4.png" alt="" height="100">
                        </a>
                        <div class="text-center">
                            <h5 class="mb-0 font-telkom">Selamat Datang</h5>
                            <p class="text-muted mt-2">Silahkan Masuk.</p>
                        </div>
                    <form class="mt-2 pt-2" method="POST" action="{{ route('loginPostAdmin') }}">
                        @csrf
                        @include('sweetalert::alert')

                        <div class="form-floating form-floating-custom mb-4">
                            <input id="username" type="text" class="form-control  @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autofocus placeholder="Email">
